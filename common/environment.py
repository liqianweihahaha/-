...
def get_hosts(env):
    ...
    return dict(tiger_api_host=tiger_api_host, platform_tiger_api_host=platform_tiger_api_host, 
        internal_account_api_host=internal_account_api_host,internal_account_service_host=internal_account_service_host, transaction_admin_api_host=transaction_admin_api_host, 
        order_service_host=order_service_host, product_service_host=product_service_host)
